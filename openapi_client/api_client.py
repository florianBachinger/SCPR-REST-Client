...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = SCPRApi()
        api_instance.train  # this is an instance of the class Endpoint
        api_instance.train()  # this invokes api_instance.train.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.train.callable or self.callable in this class
